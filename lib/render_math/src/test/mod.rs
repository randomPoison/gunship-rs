...
fn matrix_equality()
{
    let identity_1 = Matrix4::new();
    let mut identity_2 = Matrix4::new();
...
fn matrix_translation()
{
    ...
    let translation_1 = Matrix4::from_translation(0.0, 0.0, 0.0);
    let translation_2 = Matrix4::from_translation(1.0, 2.0, 3.0);
    let translation_3 = Matrix4::from_translation(1.0, 2.0, 3.0);
